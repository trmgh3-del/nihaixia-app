...
| 神农本草经 | 上137/中110/下131，含原文·性味·主治·倪注·容川注·用量·禁忌·倪师口述·补注 九类字段 | 471 味 |
| 经方库 | 原方 vs 倪师临床剂量（〔口述〕/〔换算〕标注）+ 感冒六方 + 六经主方 + 剂量速查卡 + 05/06 剂量全档原文 | 351 方 |
...
**学习中心（新增）**
- **闪卡背诵**：经方351方/本草471味3D翻卡，"记住了/再复习"队列（本地进度）
...
node --experimental-default-type=module tools/test_formula_links.mjs # 医典方剂互链检查
